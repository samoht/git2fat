...
(* OASIS_START *)
(* DO NOT EDIT (digest: 6dd08bd6008f284388f1b0dcc252703c) *)
(*
...
let setup_t =
  {
            ...
            [
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("fat-filesystem", None);
                   ...
                   {exec_custom = false; exec_main_is = "git2fat.ml"})
            ];
          plugins =
     ...
     oasis_version = "0.4.1";
     oasis_digest = Some "eK$\139\144Ã\131\141Æ¶\139j\\Ö{»";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
